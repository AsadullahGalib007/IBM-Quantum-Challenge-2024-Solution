...
# optimization_levels = [3]# Add your code here"

pass_managers = [generate_preset_pass_manager(optimization_level=level, backend=backend) for level in optimization_levels]

transpiler_services = [ 
        # {'service': TranspilerService(ai = "False", optimization_level = 1, backend_name="ibm_brisbane"), 'ai': False, 'optimization_level': 1},
        # {'service': TranspilerService(ai = "True", optimization_level = 1, backend_name="ibm_brisbane"), 'ai': True, 'optimization_level': 1},

        # {'service': TranspilerService(ai = "False", optimization_level = 2, backend_name="ibm_brisbane"), 'ai': False, 'optimization_level': 2},
        # {'service': TranspilerService(ai = "True", optimization_level = 2, backend_name="ibm_brisbane"), 'ai': True, 'optimization_level': 2},

        {'service': TranspilerService(ai = "False", optimization_level = 3, backend_name="ibm_brisbane"), 'ai': False, 'optimization_level': 3},
        {'service': TranspilerService(ai = "True", optimization_level = 3, backend_name="ibm_brisbane"), 'ai': True, 'optimization_level': 3},
    ]
